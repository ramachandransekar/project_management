...
const TeamCollaboration = ({ projectId }) => {
  ...
  const loadProjectMembers = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:8080/api/team/project/${projectId}/members`, {
        headers: {
  ...
  const loadProjectActivity = async () => {
    try {
      const response = await fetch(`http://localhost:8080/api/team/project/${projectId}/activity/recent?limit=20`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const loadProjectNote = async () => {
    try {
      const response = await fetch(`http://localhost:8080/api/team/project/${projectId}/note`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const addMemberToProject = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`http://localhost:8080/api/team/project/${projectId}/add-member`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const removeMemberFromProject = async (userId) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/team/project/${projectId}/remove-member/${userId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
