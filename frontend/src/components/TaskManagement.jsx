...
const TaskManagement = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch('https://project-management-1-kkb0.onrender.com/api/auth/users/list', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchTasks = async () => {
    try {
      ...
      const response = await fetch('https://project-management-1-kkb0.onrender.com/api/tasks', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchTaskWithDetails = async (taskId) => {
    try {
      ...
      const response = await fetch(`https://project-management-1-kkb0.onrender.com/api/tasks/${taskId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const handleCreateTask = async (e) => {
    ...
    try {
      ...
      const url = isUpdate 
        ? `https://project-management-1-kkb0.onrender.com/api/tasks/${newTask.id}`
        : 'https://project-management-1-kkb0.onrender.com/api/tasks';
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://project-management-1-kkb0.onrender.com/api/team/tasks/${selectedTask.id}/comment`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://project-management-1-kkb0.onrender.com/api/tasks/${selectedTask.id}/attachments`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  const handleStatusChange = async (newStatus) => {
    ...
    try {
      ...
      const response = await fetch(`https://project-management-1-kkb0.onrender.com/api/tasks/${selectedTask.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleDrop = async (e, targetStatus) => {
    ...
    try {
      ...
      const response = await fetch(`https://project-management-1-kkb0.onrender.com/api/tasks/${draggedTask.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
